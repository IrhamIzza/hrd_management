...
<li class="nav-item dropdown">
    ...
    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
        ...
        {{-- @forelse($unreadNotifications as $notification)
            <a href="{{ route('cuti_requests.hrd_show', $notification->cutiRequest) }}" 
        ...
        @endforelse --}}
        @forelse($unreadNotifications as $notification)
            @if (!empty($notification->cuti_request_id))
                <a href="{{ route('cuti_requests.hrd_show', $notification->cuti_request_id) }}"
