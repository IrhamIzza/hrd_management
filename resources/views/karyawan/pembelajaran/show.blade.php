            ...
            <div class="col-md-10">
                <div class="card shadow mb-4">
                    @if ($pusat_pembelajaran->thumbnail)
                        <img src="{{ asset('storage/' . $pusat_pembelajaran->thumbnail) }}" class="card-img-top"
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <iframe src="{{ asset('storage/' . $pusat_pembelajaran->konten) }}" width="100%" height="1200px"
                                style="border:1px solid #ccc;"></iframe>
                        </div>
                        <a href="{{ asset('storage/' . $pusat_pembelajaran->konten) }}" download class="btn btn-info w-100"><i
                                class="fas fa-file-download"></i> Download PDF</a>
                    </div>
                </div>
                <a href="{{ route('karyawan.pembelajaran.index') }}" class="btn btn-outline-primary"><i
                        class="fas fa-arrow-left"></i> Kembali ke Daftar Materi</a>
            </div>
        </div>
    </div>
@endsection
