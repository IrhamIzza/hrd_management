...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h1 class="h2">Manajemen Pengajuan Cuti</h1>
                ...
                <table id="cutiTable" class="table table-bordered table-hover table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                {{
                                \Carbon\Carbon::parse($cuti->start_date)->diffInDays(\Carbon\Carbon::parse($cuti->end_date))
                                + 1 }} hari
                            </td>
                            ...
                            <td>
                                <div class="btn-group">
                                    <a href="{{ route('cuti_requests.hrd_show', $cuti) }}" class="btn btn-sm btn-info"
                                        data-toggle="tooltip" title="Detail">
                                        <i class="fas fa-eye"></i> Detail
                                    </a>
                                    @if($cuti->status == 'pending')
                                    <button type="button" class="ml-2 btn btn-sm btn-success"
                                        onclick="approveRequest({{ $cuti->id }})" data-toggle="tooltip" title="Setujui">
                                        <i class="fas fa-check"></i> Setujui
                                    </button>
                                    <button type="button" class="ml-2 btn btn-sm btn-danger"
                                        onclick="rejectRequest({{ $cuti->id }})" data-toggle="tooltip" title="Tolak">
